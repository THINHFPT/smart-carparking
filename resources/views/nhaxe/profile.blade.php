    ...
    <div class="row mt-5">
        ...
        <div class="col-8">
            <div class="px-4">
                ...
                <div class="mt-5">
                    <form action="{{route('parking.createParkingHome')}}" method="POST" >
                        @csrf
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="apartment_number" id="example1" placeholder="vd : số nhà 45">
                                <span class="text-danger" >@error('apartment_number'){{$message}}@enderror</span>
                            </div>
                            <div class="col-6">
                                <label for="example2" class="form-label"> Alley</label>
                                <input type="text" class="form-control" name="alley" id="example2" placeholder="">
                        ...
                        <div class="row mb-4">
                            <div class="col-6 ">
                                ...
                                <input type="text" class="form-control" name="quarter" id="example3" />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="sdt" class="form-control" id="example6">
                        ...
                        <div class="row mb-4">
                            <div class="col-6 ">
                                ...
                                <input type="text" name="area" class="form-control" id="example7">
                                <span class="text-danger" >@error('area'){{$message}}@enderror</span>
                            </div>
                            <div class="col-6">
                                <label for="example8" class="form-label">Max slot Parking</label>
                                <input type="text" name="max_panking_slot" class="form-control" id="example8">
                        ...
                        <div class="row mb-4">
                            <div class="col-4 ">
                                ...
                                <input type="text" name="price" class="form-control" id="example9">
                                <span class="text-danger" >@error('price'){{$message}}@enderror</span>
                            </div>
                            <div class="col-4">
                                <label for="example10" class="form-label">Start Time</label>
                                <input type="text" name="start_time" class="form-control" id="example10">
                                <span class="text-danger" >@error('start_time'){{$message}}@enderror</span>
                            </div>
                            <div class="col-4 ">
                                <label for="example11" class="form-label">End Time</label>
                                <input type="text" name="end_time" class="form-control" id="example11">
