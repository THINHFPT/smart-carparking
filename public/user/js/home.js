...
function initMap() {
    map = new google.maps.Map(document.getElementById('google.map'), {
        zoom: 17,
        center: { lat: 21.0359647, lng: 105.7829678 },
        streetViewControl: false,
        mapTypeControl: false
    });

    placeMarker({ lat:  21.0359647, lng: 105.7829678 });
...
//khoi tao su kien onclick cho dropdown menu bang JS
...
xmlhttp.onload = function() {
    ...
    document.getElementById("guideline").innerHTML = myObj.Adress + ""+myObj.Status + ""+myObj.openTime+ myObj.Adres + ""+myObj.Statu + ""+myObj.openTim;
}
function myFunction(){
    var x = document.getElementById('ward').value;
    // x = xmlhttp.open("GET","xuanthuy");
    // xmlhttp.send();
}
